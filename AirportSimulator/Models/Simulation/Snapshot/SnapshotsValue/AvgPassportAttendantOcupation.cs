...
{
    internal class AvgPassportAttendantOcupation : ISnapshotMetric
    {
        public IEnvironment _environment { get; init; }
        public ISnapshotUtilities _utilities {get; init; }
        public string Lable { get; init; } = "Passport Attendant Ocupation Rate";
        public double Value { get; set; }

        public AvgPassportAttendantOcupation ( IEnvironment environment)
        {
        ...
        {
            Value = _utilities.CalulateServerOcupationPerType(typeof(PassportValidationAttendant));
            return this;
        }
    }
}
