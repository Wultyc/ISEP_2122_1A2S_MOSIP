...
{
    internal class AvgCheckinAttendantOcupation : ISnapshotMetric
    {
        public IEnvironment _environment { get; init; }
        public ISnapshotUtilities _utilities {get; init; }
        public string Lable { get; init; } = "Checkin Attendant Ocupation Rate";
        public double Value { get; set; }

        public AvgCheckinAttendantOcupation ( IEnvironment environment)
        {
        ...
        {
            Value = _utilities.CalulateServerOcupationPerType(typeof(CheckInAttendant));
            return this;
        }
    }
}
